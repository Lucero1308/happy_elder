	...
	<form class="col-12 col-xl-5" action="" method="post" data-toggle="validator" >
		...
		<div class="form-group">
			...
			<div class="input-daterange input-group" id="datepicker">
				<input type="text" class="input-sm form-control" readonly name="date_from" value="<?= $date_from ?>" />
				<span class="input-group-addon px-2">Hasta</span>
				<input type="text" class="input-sm form-control" readonly name="date_to" value="<?= $date_to ?>" /> 
			</div>
			<div class="help-block with-errors"	></div>
		</div>
		<div class="form-group">
