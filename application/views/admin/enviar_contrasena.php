<form class="form-signin text-center mt-4" action="" method="post" data-toggle="validator" >
	...
	<div class="form-group">
		<div class="input-group" >
			...
			<input type="text" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" id="userName" name="userName" class="form-control" placeholder="Correo electrónico" data-pattern-error="Ingresa un  correo válido" data-required-error="Por favor ingresa tu correo" required>
		</div>
